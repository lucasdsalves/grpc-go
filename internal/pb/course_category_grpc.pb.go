...
type CategoryServiceClient interface {
	...
	CreateCateogryStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCateogryStreamBidirectionalClient, error)
...
func (c *categoryServiceClient) CreateCateogryStreamBidirectional(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCateogryStreamBidirectionalClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCateogryStreamBidirectional", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCateogryStreamBidirectionalClient{stream}
	return x, nil
}

type CategoryService_CreateCateogryStreamBidirectionalClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCateogryStreamBidirectionalClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCateogryStreamBidirectionalClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCateogryStreamBidirectionalClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCateogryStreamBidirectional(CategoryService_CreateCateogryStreamBidirectionalServer) error
...
func (UnimplementedCategoryServiceServer) CreateCateogryStreamBidirectional(CategoryService_CreateCateogryStreamBidirectionalServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCateogryStreamBidirectional not implemented")
}
...
func _CategoryService_CreateCateogryStreamBidirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCateogryStreamBidirectional(&categoryServiceCreateCateogryStreamBidirectionalServer{stream})
}

type CategoryService_CreateCateogryStreamBidirectionalServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCateogryStreamBidirectionalServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCateogryStreamBidirectionalServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCateogryStreamBidirectionalServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCateogryStreamBidirectional",
			Handler:       _CategoryService_CreateCateogryStreamBidirectional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
